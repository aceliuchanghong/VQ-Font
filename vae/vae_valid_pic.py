...
def valid_model(
    ...
    validation_loader = DataLoader(
        val_dataset, batch_size=16, shuffle=True, drop_last=True, pin_memory=True
    )
    ...
    save_image(
        make_grid((org + 0.5).cpu().data), f"../z_using_files/imgs/{pic_name}_00.png"
    )
    save_image(
        make_grid((recon_out + 0.5).cpu().data),
        f"../z_using_files/imgs/{pic_name}_01.png",
    )
