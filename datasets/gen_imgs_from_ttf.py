...
output_dir = '../z_using_files/imgs/content_font'
test_ttf = '/mnt/data/llch/free-font/font/new_basic/content/LXGWWenKaiGB-Light.ttf'
# test_ttf = '/mnt/data/llch/VQ-Font/z_using_files/content_font/SourceHanSerifCN-Medium.ttf'
...
if __name__ == '__main__':
    ...
    cd datasets
    /usr/bin/python3 gen_imgs_from_ttf.py
